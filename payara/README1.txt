Thank you for downloading Payara Server 4.1.1.164!
...
Make sure to also check the Payara Server 4.1.1 Release Notes as they contain important information: https://github.com/payara/Payara/wiki/Release-Notes-(Payara-4.1.1.164)


5. Documentation 
================

Payara Server 4.1.1 Releases Notes: https://github.com/payara/Payara/wiki/Release-Notes-(Payara-4.1.1.164)
...
payara41/bin/asadmin --host localhost --port 4848 change-admin-password
payara41/bin/asadmin --host localhost --port 4848 enable-secure-admin
